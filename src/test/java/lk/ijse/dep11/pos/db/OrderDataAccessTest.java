...
class OrderDataAccessTest {
    ...
    void getLastOrderId() throws SQLException {
        ...
        if (count == 0){
            ...
            CustomerDataAccess.saveCustomer(new Customer("0001", "Crazy", "Panadura"));
            SingleConnectionDataSource.getInstance().getConnection().createStatement()
                    .executeUpdate("INSERT INTO \"order\" (id, customer_id) VALUES ('111111', '0001')");
    ...
    void existsOrderByCustomerId() throws SQLException {
        assertDoesNotThrow(()-> assertFalse(OrderDataAccess.existsOrderByCustomerId("0001")));
        CustomerDataAccess.saveCustomer(new Customer("0001", "Crazy", "Panadura"));
        SingleConnectionDataSource.getInstance().getConnection().createStatement()
                .executeUpdate("INSERT INTO \"order\" (id, customer_id) VALUES ('111111', '0001')");
        assertDoesNotThrow(()-> assertTrue(OrderDataAccess.existsOrderByCustomerId("0001")));
    }
